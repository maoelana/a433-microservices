...
docker tag karsajobs-ui:latest ghcr.io/maoelana/a433-microservices/karsajobs-ui:latest
...
docker push ghcr.io/maoelana/a433-microservices/karsajobs-ui:latest